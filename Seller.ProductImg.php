...
<!-- Main Image1 ------------------------------------------ -->						
							...
							<div class="form-group">
                             ...
                             <form action="Seller.ProductImg11.php"  method="post" enctype="multipart/form-data">
...
<!-- Img 2 ------------------------------------------ -->						
							...
							<div class="form-group">
                             ...
                             <form action="Seller.ProductImg22.php"  method="post" enctype="multipart/form-data">
...
<!-- Img 3 ------------------------------------------ -->						
							...
							<div class="form-group">
                             ...
                             <form action="Seller.ProductImg33.php"  method="post" enctype="multipart/form-data">
...
<!-- Img 3 ------------------------------------------ -->						
							...
							<div class="form-group">
                             ...
                             <form action="Seller.ProductImg44.php"  method="post" enctype="multipart/form-data">
