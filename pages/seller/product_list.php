    ...
    <section class="content">
      ...
      <div class="card">
		...
		?>
		  ...
		  <a class="btn btn-info btn-sm float-sm-right" href="product_add.php?var=<?php echo $var; ?>&var1=<?php echo $var1; ?>&var2=<?php echo $var2; ?>">
                              <i class="fas fa-plus">
                              </i>
                              &nbsp;Add New Product
                          </a>
        ...
        <div class="card-body p-0">
		  ...
		  <table class="table table-striped projects">
			  ...
			  require('db.php');
							...
							$sql1="SELECT * FROM products Where product_cat=$var" ;
                  ...
                  <tr>
					  ...
					  <?php 
						...
						$un23 = $_SESSION["uname"];
							$sql2="SELECT * FROM product_seller where product_id=$pid1 AND username='$un23'" ;
                        		 ...
                        		 <?php
									 ...
									 if ($sta1 == "Pending"){
										...
										<?php
									 	...
									 	?>
											<a class="btn btn-info btn-sm" href="product_list_edit.php?var=<?php echo $var; ?>&var1=<?php echo $var1; ?>&var2=<?php echo $var2; ?>&pid1=<?php echo $pid1; ?>&psid=<?php echo $psid; ?>&rt1=<?php echo $rt1; ?>&st1=<?php echo $st1; ?>">
				                              <i class="fas fa-pencil-alt">
				                              </i>
			                              Edit
				                          </a>
				                          <a class="btn btn-danger btn-sm" href="product_list_del.php?var=<?php echo $var; ?>&var1=<?php echo $var1; ?>&var2=<?php echo $var2; ?>&pid1=<?php echo $pid1; ?>&pri1=<?php echo $pri1; ?>">
						 ...
						 <?php
									 ...
									 if ($sta1 == "Pending"){
										...
										<?php
									 	...
									 	?>
										 <a class="btn btn-info btn-sm" href="product_list_add.php?var=<?php echo $var; ?>&var1=<?php echo $var1; ?>&var2=<?php echo $var2; ?>&pid1=<?php echo $pid1; ?>&pri1=<?php echo $pri1; ?>">
				                              <i class="fas fa-plus">
				                              </i>
				                              &nbsp;Add To Store
				                          </a>
