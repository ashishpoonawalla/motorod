      ...
      <div class="card">
        ...
        <div class="card-body p-2">
				...
				if($row1 = $result1->fetch_assoc())
				{
							...
							$bra1=$row1['product_brand'];
							$des1=$row1['product_desc'];
							$key1=$row1['product_keywords'];
							$wei1=$row1['weight'];
							$com1=$row1['compatible'];
					 ...
					 ?>
                        ...
                        <form action="product_editCode.php" method="post" data-form-title="Signup Seller">
                            <input type="hidden" name="pid"  value="<?php echo $pid1; ?>" >
							Product Name:
							<div class="form-group">
                                <input type="text" class="form-control" name="title" required="" value="<?php echo $tit1; ?>" placeholder="">
                            </div>
							Price:
                            <div class="form-group">
								<input  type="number" class="form-control" name="price" size="5" maxlength="5" style="width:100%; "  value="<?php echo $pri1; ?>" required="" placeholder="" >
                            </div>
							Brand:
							<div class="form-group">
							...
							Description:							
							<div class="form-group">
                                <textarea class="form-control" name="desc" rows="6" placeholder="" required=""  data-form-field="Message"><?php echo $des1; ?></textarea>
                            </div>
							
							Weight Kg:			
							<div class="form-group">
                                <input type="text" class="form-control" name="weight" required=""  value="<?php echo $wei1; ?>" placeholder="13.400">
                            </div>
							
							Compatible:
							<div class="form-group">
                                <input type="text" class="form-control" name="compatible" required="" value="<?php echo $com1; ?>"  placeholder="Hero Passion Plus, Universal, Bajaj Pulsar 135LS">
                            </div>
