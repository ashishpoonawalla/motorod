        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
			  ...
			  <form action="category_add.php" method="post" data-form-title="Signup Seller">
			  <table border="0">
			  	<tr>
					<td>
						<div class="form-group">
                            <select class="form-control" name="cat" required="" placeholder="">
								<?php
				...
				<td>
					<div class="mbr-buttons mbr-buttons--right"><button type="submit" class="mbr-buttons__btn btn btn-lg btn-warning">Add Category</button></div>
				</td>
				</tr>
			  ...
			  require('db.php');
                ...
                <tr>
				  ...
				  <?php
								...
								require('db.php');								
								$sql11="SELECT * FROM main_category where main_cat=$main1 " ;								
								$result11 = $conn->query($sql11);
								
								 if($row11 = $result11->fetch_assoc())
								 {
								  	$ccc=$row11['category_name'];
									echo $ccc;									
								 }
				  ...
				  <td>
				   	<!-- <a class="btn btn-info btn-sm" target="blank" href="brands_del.php?cid=<?php echo $bid1; ?>"> -->
