<?php 
		    ...
		    //																																										                                  t_cat, product_desc, product_keywords, product_image, img2, img3, img4
				$sql="INSERT INTO products(SKU, product_title, product_price, product_brand, product_cat, product_desc, product_keywords, product_image, img2, img3, img4, weight, compatible, status1) Values('$sku','$title','$price','$brand','$cat','$des',' ','noimg.png','noimg.png','noimg.png','noimg.png','$wei','$com','Added') " ;
