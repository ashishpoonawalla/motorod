                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
					  	...
					  	<?php 
							...
							require('db.php');
		        $sql ="";
				$sql="Update seller_info SET full_name='$full_name',phone='$ph',address='$add',city='$city',pin='$pin' Where username='$email' " ;
				 ...
				 if($row = $result->fetch_assoc())
				  {
					...
					$pin = $row["pin"];
                        ...
                        <form action="#" method="post" data-form-title="Signup Seller">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="store_name" required="" placeholder="Store Name*"   value = "<?php echo $store_name; ?>"data-form-field="Name" disabled="">
                            </div>
