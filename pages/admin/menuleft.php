  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="admin_dash.php" class="brand-link">
      <img src="../../assets/images/LogoMakr_7XVO4n.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin.motorod.in</span>
    </a>
          ...
          <li class="nav-item has-treeview">
			...
			$result1 = $conn->query($sql1);
			 ...
			 while($row1 = $result1->fetch_assoc())
			  ...
			  <li class="nav-item">
                <a href="http://localhost/1_motorod/pages/admin/product_list.php?var=<?php echo $pid1 ?>&var1=<?php echo $tlt; ?>&var2=<?php echo $tit1; ?>" class="nav-link"> <i class="far fa-circle nav-icon"></i> <p><?php echo $tit1; ?></p> </a>
              </li>
