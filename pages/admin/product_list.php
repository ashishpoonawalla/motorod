		  ...
		  <table class="table table-striped projects">
			  ...
			  require('db.php');
                  ...
                  <tr>
					  ...
					  <td class="project-state"><span class="badge badge-success"><?php echo "$sta1"; ?></span></td>
						 ...
						 <?php
									 ...
									 if ($sta1 == "Pending"){
										...
										<?php
									 	...
									 	?>
										 <a class="btn btn-info btn-sm" target="blank" href="product_edit.php?var=<?php echo $var; ?>&var1=<?php echo $var1; ?>&var2=<?php echo $var2; ?>&pid1=<?php echo $pid1; ?>">
