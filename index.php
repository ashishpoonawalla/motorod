    ...
    <div class="mbr-section__container">
        <div>
            ...
            <div class="carousel-inner" role="listbox">
			 	...
			 	<div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center  active" style="background-image: url(assets/images/slide1.jpg); height: auto; min-height: 440px; ">
                    
                </div>
				
			
				<div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center " style="background-image: url(assets/images/slide2.jpg); height: auto; min-height: 440px; ">
                   
                </div>
			
				<div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center " style="background-image: url(assets/images/slide3.jpg); height: auto;  min-height: 440px;">
