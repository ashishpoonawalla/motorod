...
<!-- Nav Bar -->
	...
	<div class="row clearfix">
		...
		<?php
			...
			$sql="SELECT * FROM worksheet ORDER BY wid DESC" ;
			 ...
			 while($row = $result->fetch_assoc())
			  {
				...
				<div class="media">
					...
					<div class="media-body">
						...
						<p>  <?php echo $det; ?> </p>	
						<p>  <?php echo $dat; ?> </p>
					    <a class="btn btn-success btn-large" href="E_worksheet1.php?var=<?php echo $wid; ?>&status=<?php echo $sta; ?>"><?php echo $sta; ?></a>
