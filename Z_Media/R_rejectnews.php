...
<!-- Nav Bar -->
	...
	<div class="row clearfix">
		...
		<?php
			...
			$sql="SELECT * FROM news where username='$uname' AND status='Reject' ORDER BY nid DESC" ;
				...
				<div class="media">
				 ...
				 <img src="<?php echo $img; ?>" width="150px" class="media-object" alt='' /></a>
					<div class="media-body">
					    ...
					    <a class="btn btn-success btn-large" href="#">EDIT</a>
						<a class="btn btn-primary btn-large" href="#">DEL</a>
