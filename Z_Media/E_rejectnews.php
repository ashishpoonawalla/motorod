...
<!-- Nav Bar -->
	...
	<div class="row clearfix">
		...
		<?php
			...
			$sql="SELECT * FROM news where status='Reject' ORDER BY nid DESC" ;
				...
				<div class="media">
				 ...
				 <img src="<?php echo $img; ?>" width="150px" class="media-object" alt='' /></a>
					<div class="media-body">
					    ...
					    <a class="btn btn-success btn-large" href="E_newsEdit.php?var=<?php echo $nid; ?>&status=<?php echo $sta; ?>"><?php echo $sta; ?></a>
						<a class="btn btn-primary btn-large" href="E_newsDel.php?var=<?php echo $nid; ?>">DEL</a>
