...
<section class="engine"><a rel="external" href="#">simple mobile web site design</a></section><section class="mbr-section mbr-after-navbar" id="page10-buttons1-0">
    <div class="mbr-section__container container mbr-section__container--isolated">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <div class="mbr-buttons mbr-buttons--center"><a class="mbr-buttons__btn btn btn-lg btn-danger" href="#/mobirise-free-win.zip">PRODUCTS</a> <a class="mbr-buttons__btn btn btn-lg btn-default" href="#/mobirise-free-mac.zip">PROFILE</a></div>
            </div>
        </div>
    </div>
</section>

<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="Seller_OrderDetails-form1-0" style="background-color: rgb(204, 204, 204);">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
                            <h2 class="mbr-header__text">ORDER DETAIL</h2>
                        </div>
                        <div data-form-alert="true">
                            <div class="hide" data-form-alert-success="true">Thanks for filling out form!</div>
                        </div>
                        <form action="#/" method="post" data-form-title="ORDER DETAIL">
                            <input type="hidden" value="6dnfhAWrIK+ltDU9tHew2O/GIq3K4ae/4A5NQRU0TybPKhdtsUJ52UiLZD4vf6w1yyCRFrbyQSHVxGpbKlEjbsLX3tpEdamaqzy35ghh6dJlJyVWAhD0/IG0PJE6A0Jm" data-form-email="true">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="message" rows="7" placeholder="Order Details" data-form-field="Message"></textarea>
                            </div>
...
<section class="mbr-section mbr-section--relative" id="page10-msg-box4-0" style="background-color: rgb(71, 85, 119);">
                ...
                <div class="mbr-box__magnet mbr-class-mbr-box__magnet--center-left col-sm-6 mbr-section__right">
                    <div class="mbr-section__container mbr-section__container--middle">
                        <div class="mbr-header mbr-header--auto-align mbr-header--wysiwyg">
                            <h3 class="mbr-header__text">PROCESS&nbsp;</h3>
