				...
				<div class="mbr-box__magnet mbr-box__magnet--top-left mbr-section__left col-sm-7">
                    <div class="mbr-section__container">
                        <div class="mbr-header mbr-header--auto-align mbr-header--wysiwyg">
							...
							<form class="example" action="Admin.Brands.php" method="GET" style="margin:auto;max-width:400px;">
  								<input type="text" style="border-color: #000; 16px;  " placeholder="Search Brands.." name="search" class="form-control" >
  							</form>
				 ...
				 <div class="mbr-box__magnet mbr-box__magnet--top-left mbr-section__right col-sm-2">
                    <div class="mbr-section__container">
                        <div class="mbr-buttons mbr-buttons--auto-align mbr-buttons--top mbr-buttons--left"><a class="mbr-buttons__btn btn btn-lg btn-success" href="Admin.CategoryAdd.php">Add Brand</a></div>
                    </div>
                </div>
    ...
    <div class="mbr-section__container container mbr-section__container--std-top-padding" style="padding-top: 93px;">
        <div class="mbr-section__row row">
			...
			if (isset($_REQUEST['search'])){			
				...
				$sql1="SELECT * FROM brands Where brand_title LIKE '%$cid%' " ;
			}
