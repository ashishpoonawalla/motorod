            ...
            <div class="col-sm-12">
                <div class="row">
					...
					<div class="col-sm-6 col-sm-offset-0" data-form-type="formoid">
						...
						<div class="mbr-header mbr-header--center mbr-header--std-padding">
                            <div class="mbr-buttons mbr-buttons--auto-align mbr-buttons--top mbr-buttons--left"><a class="mbr-buttons__btn btn btn-lg btn-default" href="#">BLOCK USER</a></div>
                        </div>
						<div class="mbr-header mbr-header--center mbr-header--std-padding">
                            <div class="mbr-buttons mbr-buttons--auto-align mbr-buttons--top mbr-buttons--left"><a class="mbr-buttons__btn btn btn-lg btn-default" href="#">UNBLOCK USER</a></div>
                        </div>
					</div>
...
?>					
                            ...
                            <div class="mbr-buttons mbr-buttons--right"><a href="Login1.php"><button type="submit" class="mbr-buttons__btn btn btn-lg btn-Default">Update Users Details</button></a></div>
							<br>
