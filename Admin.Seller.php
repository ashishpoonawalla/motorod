    ...
    <div class="mbr-section__container container mbr-section__container--std-top-padding" style="padding-top: 93px;">
        <div class="mbr-section__row row">
			...
			if (isset($_REQUEST['search'])){			
				...
				$sql1="SELECT * FROM  seller_info Where (username LIKE '%$cid%') OR (store_name LIKE '%$cid%') OR (full_name LIKE '%$cid%') OR (city LIKE '%$cid%')   " ;
			}
			 ...
			 while($row1 = $result1->fetch_assoc())
			  {
			  	...
			  	$pid1=$row1['username'];
				$tit1=$row1['store_name'];
				$email1=$row1['full_name'];
				$city1=$row1['city'];
			...
			<div class="mbr-section__col col-xs-12 col-md-3 col-sm-6">
                <div class="mbr-section__container mbr-section__container--middle">
                    <div class="mbr-header mbr-header--reduce mbr-header--center mbr-header--wysiwyg">
                        <h3 class="mbr-header__text"><a  target="_blank" href="Admin.SellerDetails.php?var=<?php echo $pid1; ?>"><?php echo $tit1; ?></a></h3>
						<br><h3 class="mbr-header__text"><a  target="_blank" href="Admin.SellerDetails.php?var=<?php echo $pid1; ?>"><?php echo $email1; ?></a></h3>
						<br><h3 class="mbr-header__text"><a  target="_blank" href="Admin.SellerDetails.php?var=<?php echo $pid1; ?>"><?php echo $city1; ?></a></h3>
