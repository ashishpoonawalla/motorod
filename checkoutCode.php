        ...
        <div class="row">
			...
			<div class="mbr-box mbr-box--fixed mbr-box--adapted">
				...
				if ($pay == "Paypal")
				{
					...
					define('PAYPAL_CANCEL_URL', 'http://localhost/1_motorod/paypal-deposit-cancel.php'); 
					define('PAYPAL_NOTIFY_URL', 'http://localhost/1_motorod/paypal-deposit-ipn.php'); 
...
<!--  ---------------------------------------------------------Display the payment button  -->
        ...
        <input type="hidden" name="return" value="http://localhost/1_motorod/paypal-deposit-success.php?var1=<?php echo $oid; ?>">
